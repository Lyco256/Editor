...
are projected from immutable service snapshots. Status rendering projects the active tab's detected
encoding and line-ending metadata. `run_interactive` uses one adapter for rendering and normalized input and
